...
## Environments
- Preview: https://main--sausaxen-iag-nmra--aemysites.aem.page/
- Live: https://main--sausaxen-iag-nmra--aemysites.aem.live/
- Block Library: https://main--sausaxen-iag-nmra--aemysites.aem.page/tools/sidekick/library.html?plugin=blocks
...
1. Open the `sausaxen-iag-nmra` directory in your favorite IDE and start coding :)
